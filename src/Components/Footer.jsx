...
const Footer = () => {
  return (
    <footer className="py-5 w-full">
      <div className="container flex flex-col md:flex-row gap-10 justify-between items-center">
        <div className="flex flex-col gap-4 ">
          <h1 className="text-white text-4xl font-normal text-center">
            JOIN OUR COMMUNITY
          </h1>
          <div className="flex justify-center md:justify-start items-center gap-6">
            <a href="https://t.me/Gangstershib_Official" target="_blank" className="">
              <svg
                width="49"
                height="49"
                viewBox="0 0 49 49"
            ...
            <a href="https://x.com/Gangstershib" target="_blank" className="">
              <svg
                width="49"
                height="49"
                viewBox="0 0 49 49"
